# Escalamiento de fallos

## Objetivos

- Explicar cómo elevar bloqueos repetidos con evidencia completa.
...
ordenados. Este laboratorio modela **escalamiento de fallos** como una operación explícita en una traza
