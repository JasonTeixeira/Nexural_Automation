# Puerta de despliegue simulado

## Objetivos

- Explicar cómo promover solo una versión reproducible probada en Playback.
...
ordenados. Este laboratorio modela **puerta de despliegue simulado** como una operación explícita en una traza
