...
- Explain how to fit every transformation inside the training boundary.
...
**causal feature pipeline** as an explicit operation in a deterministic, paper-only trace. The runner owns
