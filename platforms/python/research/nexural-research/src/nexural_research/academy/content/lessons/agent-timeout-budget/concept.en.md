...
- Explain how to stop safely at explicit time, token, and retry limits.
...
**timeout and budget control** as an explicit operation in a deterministic, paper-only trace. The runner owns
