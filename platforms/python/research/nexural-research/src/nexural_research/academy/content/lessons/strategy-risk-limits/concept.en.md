...
- Explain how to fail closed when paper-risk limits or data freshness fail.
...
**pre-trade risk limits** as an explicit operation in a deterministic, paper-only trace. The runner owns
