...
- Explain how to preserve temporal order and embargo every evaluation fold.
...
**walk-forward validation** as an explicit operation in a deterministic, paper-only trace. The runner owns
