# Estrés de costes de ejecución

## Objetivos

- Explicar cómo recalcular evidencia con comisiones, spread y slippage.
...
ordenados. Este laboratorio modela **estrés de costes de ejecución** como una operación explícita en una traza
