...
- Explain how to retry transient paper-bridge failures without duplicate intent.
...
**bounded retry policy** as an explicit operation in a deterministic, paper-only trace. The runner owns
