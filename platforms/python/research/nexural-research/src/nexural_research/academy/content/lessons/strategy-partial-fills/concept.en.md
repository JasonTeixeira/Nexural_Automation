...
- Explain how to reconcile quantity and average price across partial executions.
...
**partial-fill accounting** as an explicit operation in a deterministic, paper-only trace. The runner owns
