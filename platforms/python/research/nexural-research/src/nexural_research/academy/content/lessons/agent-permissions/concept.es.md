...
- Explicar cómo conceder solo herramientas y datos del ámbito de la tarea.
...
ordenados. Este laboratorio modela **permisos de mínimo privilegio** como una operación explícita en una traza
