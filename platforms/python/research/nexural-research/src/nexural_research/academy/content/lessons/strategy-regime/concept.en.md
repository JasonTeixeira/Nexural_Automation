...
- Explain how to gate signals using only information available at decision time.
...
**regime gates** as an explicit operation in a deterministic, paper-only trace. The runner owns
