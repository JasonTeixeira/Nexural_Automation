# Managed Order Semantics

## Objectives

- Explain how to model entry handling and signal-name constraints.
...
**managed order semantics** as an explicit operation in a deterministic, paper-only trace. The runner owns
