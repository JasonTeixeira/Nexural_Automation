...
- Explain how to make merge and rollover assumptions explicit and reproducible.
...
**contract rollover policy** as an explicit operation in a deterministic, paper-only trace. The runner owns
