...
- Explain how to choose OnBarClose, OnEachTick, or OnPriceChange deliberately.
...
**calculate modes** as an explicit operation in a deterministic, paper-only trace. The runner owns
