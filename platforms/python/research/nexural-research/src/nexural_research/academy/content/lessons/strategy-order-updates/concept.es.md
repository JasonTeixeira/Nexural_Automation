# Gestión de actualizaciones de orden

## Objetivos

- Explicar cómo consumir actualizaciones sin asumir el orden del proveedor.
...
ordenados. Este laboratorio modela **gestión de actualizaciones de orden** como una operación explícita en una traza
