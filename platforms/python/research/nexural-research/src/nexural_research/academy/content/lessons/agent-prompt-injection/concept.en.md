...
- Explain how to treat external content as data rather than authority.
...
**prompt injection boundaries** as an explicit operation in a deterministic, paper-only trace. The runner owns
