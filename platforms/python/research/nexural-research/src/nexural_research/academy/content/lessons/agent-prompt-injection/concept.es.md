# Límites ante inyección de prompts

## Objetivos

- Explicar cómo tratar contenido externo como datos y no autoridad.
...
ordenados. Este laboratorio modela **límites ante inyección de prompts** como una operación explícita en una traza
