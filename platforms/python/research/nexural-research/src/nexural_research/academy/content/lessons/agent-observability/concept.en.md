...
- Explain how to record decisions, tools, inputs, and bounded outputs.
...
**agent observability** as an explicit operation in a deterministic, paper-only trace. The runner owns
