...
- Explain how to make bounded plans inspectable before execution.
...
**deterministic plans** as an explicit operation in a deterministic, paper-only trace. The runner owns
