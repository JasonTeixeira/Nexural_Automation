# Historical to Realtime Transition

## Objectives

- Explain how to separate historical, transition, and realtime behavior.
...
**historical to realtime transition** as an explicit operation in a deterministic, paper-only trace. The runner owns
...
and add the recovery operation required by the seeded `duplicate` scenario. Never paste expected
