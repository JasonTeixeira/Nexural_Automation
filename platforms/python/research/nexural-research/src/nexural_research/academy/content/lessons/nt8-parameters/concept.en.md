...
- Explain how to persist bounded strategy parameters with stable defaults.
...
**parameters and serialization** as an explicit operation in a deterministic, paper-only trace. The runner owns
