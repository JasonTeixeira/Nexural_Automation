# Control de límites de sesión

## Objetivos

- Explicar cómo reiniciar el estado una sola vez en el límite de sesión.
...
ordenados. Este laboratorio modela **control de límites de sesión** como una operación explícita en una traza
