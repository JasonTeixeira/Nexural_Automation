...
- Explain how to segment regimes without future-informed labels.
...
**regime segmentation** as an explicit operation in a deterministic, paper-only trace. The runner owns
