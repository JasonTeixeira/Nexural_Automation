# Estrés Monte Carlo de trayectorias

## Objetivos

- Explicar cómo estresar el riesgo de secuencia con semillas deterministas.
...
ordenados. Este laboratorio modela **estrés monte carlo de trayectorias** como una operación explícita en una traza
