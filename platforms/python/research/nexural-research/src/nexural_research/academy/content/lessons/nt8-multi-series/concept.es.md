# Sincronización multiserie

## Objetivos

- Explicar cómo proteger BarsInProgress y CurrentBars antes del acceso entre series.
...
ordenados. Este laboratorio modela **sincronización multiserie** como una operación explícita en una traza
