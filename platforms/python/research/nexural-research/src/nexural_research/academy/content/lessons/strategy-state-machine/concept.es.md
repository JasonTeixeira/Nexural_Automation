# Estado determinista de estrategia

## Objetivos

- Explicar cómo hacer explícita cada transición permitida.
...
ordenados. Este laboratorio modela **estado determinista de estrategia** como una operación explícita en una traza
