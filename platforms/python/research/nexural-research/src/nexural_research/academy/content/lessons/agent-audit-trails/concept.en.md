...
- Explain how to detect missing or modified automation records.
...
**tamper-evident audit trails** as an explicit operation in a deterministic, paper-only trace. The runner owns
