# Strategy Analyzer Reproducibility

## Objectives

- Explain how to capture analyzer, fill-resolution, and optimization settings.
...
**strategy analyzer reproducibility** as an explicit operation in a deterministic, paper-only trace. The runner owns
