...
- Explain how to reject tools outside the declared mission contract.
...
**tool allowlists** as an explicit operation in a deterministic, paper-only trace. The runner owns
