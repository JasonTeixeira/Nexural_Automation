...
- Explain how to replay the durable log without duplicating effects.
...
**restart replay** as an explicit operation in a deterministic, paper-only trace. The runner owns
