# Liberación de recursos del indicador

## Objetivos

- Explicar cómo liberar recursos en el estado de terminación correcto.
...
ordenados. Este laboratorio modela **liberación de recursos del indicador** como una operación explícita en una traza
