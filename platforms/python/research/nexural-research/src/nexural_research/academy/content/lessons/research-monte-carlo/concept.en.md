...
- Explain how to stress sequence risk with deterministic seeds.
...
**monte carlo path stress** as an explicit operation in a deterministic, paper-only trace. The runner owns
