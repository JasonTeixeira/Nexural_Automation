# Política de rollover de contratos

## Objetivos

- Explicar cómo hacer explícitos y reproducibles los supuestos de unión y rollover.
...
ordenados. Este laboratorio modela **política de rollover de contratos** como una operación explícita en una traza
...
añade la recuperación exigida por el escenario `stale_data`. No pegues booleanos esperados: el grader
