# IDs de secuencia monótonos

## Objetivos

- Explicar cómo detectar huecos, reordenamiento y repetición.
...
ordenados. Este laboratorio modela **ids de secuencia monótonos** como una operación explícita en una traza
