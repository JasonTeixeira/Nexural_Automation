# Playback y Market Replay

## Objetivos

- Explicar cómo distinguir Replay101, Sim101, histórico y Playback síncrono.
...
ordenados. Este laboratorio modela **playback y market replay** como una operación explícita en una traza
