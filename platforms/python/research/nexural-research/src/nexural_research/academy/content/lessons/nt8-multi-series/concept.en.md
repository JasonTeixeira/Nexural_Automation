...
- Explain how to guard BarsInProgress and CurrentBars before cross-series access.
...
**multi-series synchronization** as an explicit operation in a deterministic, paper-only trace. The runner owns
