# Ciclo de estados de NinjaScript

## Objetivos

- Explicar cómo configurar recursos por estado sin fugas de ciclo de vida.
...
ordenados. Este laboratorio modela **ciclo de estados de ninjascript** como una operación explícita en una traza
