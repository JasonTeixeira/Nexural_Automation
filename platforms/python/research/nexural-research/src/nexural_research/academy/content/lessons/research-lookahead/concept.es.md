# Pipeline causal de variables

## Objetivos

- Explicar cómo ajustar cada transformación dentro del límite de entrenamiento.
...
ordenados. Este laboratorio modela **pipeline causal de variables** como una operación explícita en una traza
