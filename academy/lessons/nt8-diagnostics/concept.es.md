# TraceOrders y diagnóstico

## Objetivos

- Explicar cómo emitir contexto diagnóstico acotado para cada transición de orden.
...
ordenados. Este laboratorio modela **traceorders y diagnóstico** como una operación explícita en una traza
