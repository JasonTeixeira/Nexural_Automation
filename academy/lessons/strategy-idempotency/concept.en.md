...
- Explain how to turn repeated signals into one paper intent.
...
**signal idempotency** as an explicit operation in a deterministic, paper-only trace. The runner owns
