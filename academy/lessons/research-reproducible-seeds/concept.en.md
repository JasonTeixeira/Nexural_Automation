...
- Explain how to make stochastic evidence exactly replayable.
...
**reproducible randomness** as an explicit operation in a deterministic, paper-only trace. The runner owns
