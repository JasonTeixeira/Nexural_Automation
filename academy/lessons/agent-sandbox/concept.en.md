...
- Explain how to execute untrusted workloads without host authority.
...
**sandbox policy** as an explicit operation in a deterministic, paper-only trace. The runner owns
