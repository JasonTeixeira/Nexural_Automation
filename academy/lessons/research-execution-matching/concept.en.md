# Execution-to-Trade Matching

## Objectives

- Explain how to derive trades from ordered execution facts.
...
**execution-to-trade matching** as an explicit operation in a deterministic, paper-only trace. The runner owns
