...
- Explain how to pause before consequential external state changes.
...
**human approval gates** as an explicit operation in a deterministic, paper-only trace. The runner owns
