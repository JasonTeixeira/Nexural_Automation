...
- Explain how to prevent cross-account routing and state leakage.
...
**account isolation** as an explicit operation in a deterministic, paper-only trace. The runner owns
