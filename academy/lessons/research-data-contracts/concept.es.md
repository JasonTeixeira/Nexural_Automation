# Contratos de datos de mercado

## Objetivos

- Explicar cómo rechazar esquemas inválidos y tiempos imposibles antes del análisis.
...
ordenados. Este laboratorio modela **contratos de datos de mercado** como una operación explícita en una traza
