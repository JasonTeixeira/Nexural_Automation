...
- Explain how to reject malformed schemas and impossible timestamps before analysis.
...
**market data contracts** as an explicit operation in a deterministic, paper-only trace. The runner owns
