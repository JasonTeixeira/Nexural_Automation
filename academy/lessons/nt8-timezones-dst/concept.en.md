# Trading Hours, Time Zones, and DST

## Objectives

- Explain how to normalize timestamps using the instrument trading-hours template.
...
**trading hours, time zones, and dst** as an explicit operation in a deterministic, paper-only trace. The runner owns
...
and add the recovery operation required by the seeded `stale_data` scenario. Never paste expected
