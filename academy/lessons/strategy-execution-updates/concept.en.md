...
- Explain how to drive protection from execution facts rather than intent.
...
**execution update handling** as an explicit operation in a deterministic, paper-only trace. The runner owns
