# Transición de histórico a tiempo real

## Objetivos

- Explicar cómo separar el comportamiento histórico, de transición y en tiempo real.
...
ordenados. Este laboratorio modela **transición de histórico a tiempo real** como una operación explícita en una traza
...
añade la recuperación exigida por el escenario `duplicate`. No pegues booleanos esperados: el grader
