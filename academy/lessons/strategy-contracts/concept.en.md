...
- Explain how to encode inputs, invariants, and non-goals before implementation.
...
**strategy contracts** as an explicit operation in a deterministic, paper-only trace. The runner owns
