...
- Explain how to acknowledge only after durable application.
...
**acknowledgement protocol** as an explicit operation in a deterministic, paper-only trace. The runner owns
