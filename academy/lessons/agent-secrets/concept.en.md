...
- Explain how to keep credentials out of prompts, traces, and artifacts.
...
**secrets boundary** as an explicit operation in a deterministic, paper-only trace. The runner owns
