...
- Explain how to report uncertainty without destroying dependence structure.
...
**bootstrap uncertainty** as an explicit operation in a deterministic, paper-only trace. The runner owns
