...
- Explain how to reject intent beyond its event-time validity window.
...
**stale signal rejection** as an explicit operation in a deterministic, paper-only trace. The runner owns
