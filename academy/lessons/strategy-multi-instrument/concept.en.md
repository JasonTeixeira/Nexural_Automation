...
- Explain how to prevent state and order crossover between instruments.
...
**multi-instrument isolation** as an explicit operation in a deterministic, paper-only trace. The runner owns
