...
- Explain how to bind every material claim to source and retrieval time.
...
**data provenance** as an explicit operation in a deterministic, paper-only trace. The runner owns
