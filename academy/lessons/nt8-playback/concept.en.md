# Playback and Market Replay

## Objectives

- Explain how to distinguish Replay101, Sim101, historical, and synchronous Playback.
...
**playback and market replay** as an explicit operation in a deterministic, paper-only trace. The runner owns
...
and add the recovery operation required by the seeded `latency` scenario. Never paste expected
