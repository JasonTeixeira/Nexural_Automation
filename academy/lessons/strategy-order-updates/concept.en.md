...
- Explain how to consume order updates without assuming provider ordering.
...
**order update handling** as an explicit operation in a deterministic, paper-only trace. The runner owns
