...
- Explain how to make at-least-once delivery produce exactly-once effect.
...
**at-least-once delivery** as an explicit operation in a deterministic, paper-only trace. The runner owns
