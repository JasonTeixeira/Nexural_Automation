...
- Explicar cómo lograr efecto único con entrega al menos una vez.
...
ordenados. Este laboratorio modela **entrega al menos una vez** como una operación explícita en una traza
