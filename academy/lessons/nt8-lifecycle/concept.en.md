# NinjaScript State Lifecycle

## Objectives

- Explain how to configure state-specific resources without lifecycle leakage.
...
**ninjascript state lifecycle** as an explicit operation in a deterministic, paper-only trace. The runner owns
