# Límites de riesgo preoperación

## Objetivos

- Explicar cómo cerrar de forma segura al fallar límites o frescura de datos.
...
ordenados. Este laboratorio modela **límites de riesgo preoperación** como una operación explícita en una traza
