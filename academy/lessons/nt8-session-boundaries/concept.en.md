...
- Explain how to reset state exactly once at a trading-session boundary.
...
**session boundary control** as an explicit operation in a deterministic, paper-only trace. The runner owns
