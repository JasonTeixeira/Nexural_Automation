...
- Explain how to fail closed across process and machine restart.
...
**persistent kill switch** as an explicit operation in a deterministic, paper-only trace. The runner owns
