# Optimization Bias Controls

## Objectives

- Explain how to record the complete search space and selection process.
...
**optimization bias controls** as an explicit operation in a deterministic, paper-only trace. The runner owns
