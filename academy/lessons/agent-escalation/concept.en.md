...
- Explain how to surface repeated blockers with complete evidence.
...
**failure escalation** as an explicit operation in a deterministic, paper-only trace. The runner owns
