...
- Explain how to stop safely when peer liveness becomes uncertain.
...
**heartbeat and liveness** as an explicit operation in a deterministic, paper-only trace. The runner owns
