# Semántica de órdenes administradas

## Objetivos

- Explicar cómo modelar reglas de entrada y nombres de señal.
...
ordenados. Este laboratorio modela **semántica de órdenes administradas** como una operación explícita en una traza
