...
- Explain how to recompute evidence across commissions, spread, and slippage.
...
**execution cost stress** as an explicit operation in a deterministic, paper-only trace. The runner owns
