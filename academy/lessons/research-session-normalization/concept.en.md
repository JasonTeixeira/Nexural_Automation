...
- Explain how to align bars and events to an explicit exchange calendar.
...
**session normalization** as an explicit operation in a deterministic, paper-only trace. The runner owns
