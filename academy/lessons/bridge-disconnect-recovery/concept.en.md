...
- Explain how to resume only after checkpoint and state reconciliation.
...
**disconnect recovery** as an explicit operation in a deterministic, paper-only trace. The runner owns
