...
- Explicar cómo preservar orden temporal y embargo en cada fold.
...
ordenados. Este laboratorio modela **validación walk-forward** como una operación explícita en una traza
