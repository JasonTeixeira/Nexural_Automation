...
- Explain how to make every allowed strategy transition explicit.
...
**deterministic strategy state** as an explicit operation in a deterministic, paper-only trace. The runner owns
