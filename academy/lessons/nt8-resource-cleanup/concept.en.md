# Indicator Resource Cleanup

## Objectives

- Explain how to release runtime resources in the correct termination state.
...
**indicator resource cleanup** as an explicit operation in a deterministic, paper-only trace. The runner owns
