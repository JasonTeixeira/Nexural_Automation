...
- Explain how to bind code, data, parameters, folds, and artifacts by hash.
...
**reproducible evidence bundles** as an explicit operation in a deterministic, paper-only trace. The runner owns
