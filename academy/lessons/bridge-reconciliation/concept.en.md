...
- Explain how to converge local paper state on authoritative observations.
...
**state reconciliation** as an explicit operation in a deterministic, paper-only trace. The runner owns
