# Parámetros y serialización

## Objetivos

- Explicar cómo persistir parámetros acotados con valores predeterminados estables.
...
ordenados. Este laboratorio modela **parámetros y serialización** como una operación explícita en una traza
